Public Class acManualReserveFill
#If 0 Then
  VERSION 1.0 CLASS
BEGIN
  MultiUse = -1  'True
...
END
Attribute VB_Name = "ACManualReserveFill"
...
'
  Option Explicit
  Public Enum ManualReserveFillState
    Off
    Interlock
    FillingHot
    FillingCold
  End Enum
  Public State As ManualReserveFillState
  

Public Sub Run(FillLevel As Long, ReserveLevel As Long, FillHot As Boolean, _
              FillCold As Boolean)
    ...
    Select Case State
       ...
       Case FillingHot
          ...
          If (ReserveLevel >= (FillLevel * 10)) Then
             State = Off
             FillHot = False
          End If
